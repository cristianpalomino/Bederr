 ...
 */
public class Adapter_Locales_Pregunta extends BaseAdapter {
    ...
    public Adapter_Locales_Pregunta(Context context, ArrayList<Local_DTO> local_dtos, int tipo) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.view_local_responder, parent, false);
            holder = new Holder();
        ...
        try {
            ...
            if(tipo == 1){
                if(jsonArray_life.length() > 0){
                    holder.img_plomo.setVisibility(View.GONE);
                }
            }

 ...
 */
public class Fragment_Detalle_Cupon_Life extends Fragment_Master implements Dialog_Cupon.Interface_Dialog_Cupon {

    private Cupon_DTO cupon_dto;
    private String nombre_local;

    public Fragment_Detalle_Cupon_Life() {
        setId_layout(R.layout.fragment_detalle_cupon_life);
        setId_container(R.id.frame_container);
    }

    public static final Fragment_Detalle_Cupon_Life newInstance() {
        return new Fragment_Detalle_Cupon_Life();
    }
    ...
    protected void initView() {
        ...
        Fragment_Detalle_Cupon_Life.this.onFinishLoad(getView());
        try {
            ...
            getView().findViewById(R.id.card_tipo_cupon).setBackgroundResource(R.drawable.holo_flat_button_plomo_claro);
        } catch (JSONException e) {
            e.printStackTrace();
        }

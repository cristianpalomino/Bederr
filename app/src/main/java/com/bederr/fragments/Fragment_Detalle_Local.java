...
import com.bederr.views.View_Cupon;
 ...
 */
public class Fragment_Detalle_Local extends Fragment_Master {

    private GoogleMap map;

    public Fragment_Detalle_Local() {
    ...
    protected void initView() {
        ...
        Fragment_Detalle_Local.this.onFinishLoad(getView());
